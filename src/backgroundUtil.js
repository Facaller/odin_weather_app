    ...
    constructor () {
        this.conditionMap = {
            clear: {
                ...
                videos: ['./assets/images/minecraft_backgrounds/clear1.mp4', './assets/images/minecraft_backgrounds/clear2.mp4']
            },
            cloudy: {
                keywords: ['overcast', 'partially cloudy', 'sky coverage decreasing', 'sky coverage increasing'],
                videos: ['./assets/images/minecraft_backgrounds/cloudy1.mp4', './assets/images/minecraft_backgrounds/cloudy2.mp4', './assets/images/minecraft_backgrounds/cloudy3.mp4']
            },
            fog: {
                keywords: ['fog', 'freezing fog', 'mist', 'smoke or haze'],
                videos: ['./assets/images/minecraft_backgrounds/fog1.mp4']
            },
            rain: {
                ...
                videos: ['./assets/images/minecraft_backgrounds/rain1.mp4', './assets/images/minecraft_backgrounds/rain2.mp4', './assets/images/minecraft_backgrounds/rain3.mp4']
            },
            snow: {
                ...
                videos: ['./assets/images/minecraft_backgrounds/snow1.mp4', './assets/images/minecraft_backgrounds/snow2.mp4']
            },
            storm: {
                keywords: ['funnel cloud/tornado', 'squalls', 'thunderstorm', 'thunderstorm without precipitation', 'lightning without thunder'],
                videos: ['./assets/images/minecraft_backgrounds/storm1.mp4']
            },
        }
    }
